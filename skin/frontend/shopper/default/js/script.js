...
jQuery(function($){
	...
	$('div.cart-top-container').hover(
        function(){
            if (mobile) return;
            // $('.search-top-container .search-form').animate({opacity:1, height:'toggle'}, 200);
			$('.cart-top-container .details').css('opacity', 1);
			$('.cart-top-container .details').css("display", "block");
        },
        function(){
            if (mobile) return;
            // $('.search-top-container .search-form').animate({opacity:0, height:'toggle'}, 200);
			$('.cart-top-container .details').css('opacity', 0);
			$('.cart-top-container .details').css("display", "none");
        }
    );
    //compare dropdown
    var config = {
	...
	$('div.compare-top-container').hover(
        function(){
            if (mobile) return;
            // $('.search-top-container .search-form').animate({opacity:1, height:'toggle'}, 200);
			$('.compare-top-container .details').css('opacity', 1);
			$('.compare-top-container .details').css("display", "block");
        },
        function(){
            if (mobile) return;
            // $('.search-top-container .search-form').animate({opacity:0, height:'toggle'}, 200);
			$('.compare-top-container .details').css('opacity', 0);
			$('.compare-top-container .details').css("display", "none");
        }
    );
    //search dropdown
    var config = {
	...
	$('div.search-top-container').hover(
        function(){
            if (mobile) return;
            // $('.search-top-container .search-form').animate({opacity:1, height:'toggle'}, 200);
			$('.search-top-container .search-form').css('opacity', 1);
			$('.search-top-container .search-form').css("display", "block");
        },
        function(){
            if (mobile) return;
            // $('.search-top-container .search-form').animate({opacity:0, height:'toggle'}, 200);
			$('.search-top-container .search-form').css('opacity', 0);
			$('.search-top-container .search-form').css("display", "none");
        }
    );
