...
$cnt = count($total);
	...
	if($noofside == 1)
	{
		...
		$data['fa_output_width'] = $total[COORDINATE][OW];
		$data['fa_output_height'] = $total[COORDINATE][OH];
	...
	}else if($noofside == 2 )
	{
		...
		$data['fa_output_width'] = $total[0][COORDINATE][OW];
		$data['fa_output_height'] = $total[0][COORDINATE][OH];
		...
		$data['ba_output_width'] = $total[1][COORDINATE][OW];
		$data['ba_output_height'] = $total[1][COORDINATE][OH];
	...
	}else if($noofside == 3 )
	{
		...
		$data['le_output_width'] = $total[2][COORDINATE][OW];
		$data['le_output_height'] = $total[2][COORDINATE][OH];
	...
	}else if($noofside == 4 )
	{
		...
		$data['ri_output_width'] = $total[3][COORDINATE][OW];
		$data['ri_output_height'] = $total[3][COORDINATE][OH];
	}
