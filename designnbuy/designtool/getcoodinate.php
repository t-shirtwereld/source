...
$no_of_sides = $productData->getAttributeText('no_of_sides'); //getNo_of_sides();	 
 ...
 {	 
  ...
  $flashvar.="<OW>".$product->getFa_output_width()."</OW>";
  $flashvar.="<OH>".$product->getFa_output_height()."</OH>";
  $flashvar.="</COORDINATE>";
  $flashvar.="</IMAGE>";
  $flashvar.="</IMAGES>";
 ...
 }else if($no_of_sides == '2')
 {
  ...
  $flashvar.="<OW>".$product->getBa_output_width()."</OW>";
  $flashvar.="<OH>".$product->getBa_output_height()."</OH>";
  $flashvar.="</COORDINATE>";
  $flashvar.="</IMAGE>";
 ...
 }else if($no_of_sides == '3')
 {
	  ...
	  $flashvar.="<OW>".$product->getLe_output_width()."</OW>";
	  $flashvar.="<OH>".$product->getLe_output_height()."</OH>";
	  $flashvar.="</COORDINATE>";
	  $flashvar.="</IMAGE>";
 ...
 }else if($no_of_sides == '4')
 {
	  ...
	  $flashvar.="<OW>".$product->getRi_output_width()."</OW>";
	  $flashvar.="<OH>".$product->getRi_output_height()."</OH>";
	  $flashvar.="</COORDINATE>";
	  $flashvar.="</IMAGE>";
