...
<html>  
	...
	<table>  
	    ...
	    //$dir = $_SERVER['DOCUMENT_ROOT'] . '/work/print_commerce/pc-newtool/source/designnbuy/designtool/help/images/';
		...
		//    continue;  
		//$imageurl = 'http://192.168.0.139/work/print_commerce/pc-newtool/source/designnbuy/designtool/help/images';
		$imageurl = $_GET['imagepath'];
		$thumbSrc = $imageurl . '/' . $file;
		$fileBaseName = $file;
...
?>];  
		...
		tbl.onclick =   
		    ...
		    url = '<?php echo $imageurl; ?>' + '/' + tgt.title;  
