...
<div class="input-area" style="margin-bottom:30px;">
	...
	<!-- Add By Ashok for Multicolor -->
	<?php if( count($product_colors)){ ?>
	 <div class="field-set">
	<label>Multicolor</label>
	<div class="input-field" style="margin-top:4px;">
	
	    <?php if(isset($product_settings['is_multicolor']) && $product_settings['is_multicolor']) { ?>
	    Yes <input type="radio" <?php if ($product_settings['is_multicolor'] == '1') { ?> checked <?php } ?> name="is_multicolor" value="1" >&nbsp;&nbsp;&nbsp;&nbsp;
	    No <input type="radio" name="is_multicolor" <?php if ($product_settings['is_multicolor'] == '0'){ ?> checked <?php } ?>  value="0" >
	    <?php } else { ?>
	    Yes <input type="radio" name="is_multicolor" value="1" >&nbsp;&nbsp;&nbsp;&nbsp;
	    No <input type="radio" name="is_multicolor" value="0" checked>
	    <?php } ?>
	</div>
    </div>
	<?php } ?>
	...
	<!-- Add By Somin for 3D product -->
	 <div class="field-set">
	<label>Is 3D</label>
	<div class="input-field" style="margin-top:4px;">
	
	    <?php if(isset($product_settings['is_3d']) && $product_settings['is_3d']) { ?>
	    Yes <input type="radio" <?php if ($product_settings['is_3d'] == '1') { ?> checked <?php } ?> name="is_3d" value="1" >&nbsp;&nbsp;&nbsp;&nbsp;
	    No <input type="radio" name="is_3d" <?php if ($product_settings['is_3d'] == '0'){ ?> checked <?php } ?>  value="0" >
	    <?php } else { ?>
	    Yes <input type="radio" name="is_3d" value="1" >&nbsp;&nbsp;&nbsp;&nbsp;
	    No <input type="radio" name="is_3d" value="0" checked>
	    <?php } ?>
	</div>
    </div>
	...
	<div class="input-field" style="margin-top:4px;">
	    <select  name="output" id="output">
            <option value="svgpdfpng" <?php if ($product_settings['output'] == 'svgpdfpng'): ?> selected <?php endif; ?>>SVG+PDF+PNG&nbsp;&nbsp;</option>
            <option value="svgpdfeps" <?php if ($product_settings['output'] == 'svgpdfeps'): ?> selected <?php endif; ?> >SVG+PDF+EPS&nbsp;&nbsp;</option>
         </select>
	</div>
    </div>
