<div class="pc_contten">
   ...
   <div class="pc_rgt"><a href="<?php echo BASE_ADMIN_URL . 'qranges/importcsv'; ?>">Import Quantity Ranges</a></div>
	...
	<div class="pc_contten box-box">
	    <form id="editForm" action="<?php echo BASE_ADMIN_URL . 'qranges/submitdata'; ?>" method="post" class="col-two">
		<input type="hidden" name="qrange_id" value="<?php echo $qrange_row['qrange_id'] ?>" />
		<div class="input-area" style="margin-bottom:30px;">
			...
			<div class="field-form">
				...
				<input type="text" name="quantity_range_from" value="<?php echo $qrange_row['quantity_range_from'] ?>" placeholder="" />
			    </div>
			</div>
		    </div>
		    <div class="field-set">
			...
			<div class="field-form">
				...
				<input type="text" name="quantity_range_to" value="<?php echo $qrange_row['quantity_range_to'] ?>" placeholder="" />
			    </div>
			</div>
		    </div>
		</div>
