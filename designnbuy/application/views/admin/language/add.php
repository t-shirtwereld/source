<div class="pc_contten">
	...
	<div class="pc_contten box-box">
	    <form id="addForm" action="<?php echo BASE_ADMIN_URL . 'language/submitdata'; ?>" method="post" class="col-two">
		...
		<div class="input-area" style="margin-bottom:30px;">
			...
			<div class="input-field">
			    <input name="iso_code" type="text" value="" placeholder=""/>
			</div>
		    </div>
		    <div class="field-set">
			<label>Language Code</label>
			<div class="input-field">
			    <input name="language_code" type="text" value="" placeholder=""/>
			</div>
		    </div>
		    <div class="field-set">
			<label>Language Abbreviation</label>
			<div class="input-field">
			    <input name="connector" type="text" value="" placeholder=""/>
			</div>
		    </div>
		    <div class="field-set">
