<div class="pc_contten">
	...
	<div class="pc_contten box-box">
	    <form id="addForm" action="<?php echo BASE_ADMIN_URL . 'color_counters/submitdata'; ?>" method="post" class="col-two">
		<input type="hidden" name="color_counter_id" value="" />
		<div class="input-area" style="margin-bottom:30px;">
		    <div class="field-set">
			<label>Color Counter</label>
			<div class="field-form">
			    <div class="input-field validationclass">
				<input type="text" name="color_counter" value="" placeholder="" />
			    </div>
			</div>
		    </div>
		</div>
