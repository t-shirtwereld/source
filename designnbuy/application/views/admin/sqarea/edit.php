<div class="pc_contten">
	...
	<div class="pc_contten box-box">
	    <form id="editForm" action="<?php echo BASE_ADMIN_URL . 'sqarea/submitdata'; ?>" method="post" class="col-two">
		<input type="hidden" name="sqarea_id" value="<?php echo $sqarea_row['sqarea_id'] ?>" />
		<div class="input-area" style="margin-bottom:30px;">
		    <div class="field-set">
			<label>Square Area</label>
			<div class="field-form">
			    <div class="input-field validationclass">
				<input type="text" name="square_area" value="<?php echo $sqarea_row['square_area'] ?>" placeholder="" />
			    </div>
			</div>
		    </div>
		</div>
