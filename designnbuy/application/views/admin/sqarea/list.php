<div class="pc_contten">
    <div class="pc_top">
        <h1>Artwork Area Sizes</h1>
	<div class="pc_rgt" style="margin-left: 10px;"><a href="<?php echo BASE_ADMIN_URL . 'sqarea/addsqarea'; ?>">Add Artwork Area Size</a></div>
	<div class="pc_rgt"><a href="<?php echo BASE_ADMIN_URL . 'sqarea/importcsv'; ?>">Import Artwork Area Sizes</a></div>
    </div>

    <div class="pc_search">
	<div class="switcher">
	    <form name="search" action="<?php echo BASE_ADMIN_URL . 'sqarea/index/'; ?>" method="get">
		...
		<a href="<?php echo BASE_ADMIN_URL . 'sqarea'; ?>" style="float: right; margin: 0px 8px; line-height: 36px;"><img src="<?php echo base_url('assets/images/recet.png'); ?>" alt=""></a>
	    </form>
	</div>
    </div>
	...
	<?php
	if (!empty($sqareas)) {
	    foreach ($sqareas as $s) {
		?>
		<tr>
		    <td><?php echo $s['sqarea_id']; ?></td>
		    <td><?php echo $s['square_area']; ?></td> 
		    <td><a href="<?php echo BASE_ADMIN_URL . 'sqarea/editsqarea/' . $s['sqarea_id']; ?>">Edit</a>&nbsp;&nbsp;&nbsp;<a class="delete" href="<?php echo BASE_ADMIN_URL . 'sqarea/deletesqarea/' . $s['sqarea_id']; ?>">Delete</a></td>
		</tr>
		<?php
	    }
	} else {
...
<script>
	...
	$('#limit').bind('change', function () {
	    ...
	    var url = "<?php echo BASE_ADMIN_URL . 'sqarea/index?keyword='.$keyword.'&limit='; ?>"+limit_val;
