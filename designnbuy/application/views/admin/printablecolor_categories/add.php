<div class="pc_contten">
	...
	<div class="pc_contten box-box">
	    <form id="addCategoryForm" action="<?php echo BASE_ADMIN_URL . 'printablecolor_categories/submitdata'; ?>" method="post" class="col-two">
		<input type="hidden" name="printablecolor_category_id" value="" />
