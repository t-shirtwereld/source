<div class="pc_contten">
	...
	<div class="pc_contten box-box">
	    <form id="addColorForm" action="<?php echo BASE_ADMIN_URL . 'printablecolors/submitdata'; ?>" method="post" class="col-two">
		<input type="hidden" name="printablecolor_id" value="" />
		<div class="input-area" style="margin-bottom:30px;">
			...
			<div class="field-form">
			    <?php foreach ($languages as $language) { ?>
    				...
    				<input type="text" name="printablecolor_name[<?php echo $language['language_id']; ?>][name]" value="" placeholder="" />
			...
			<div class="input-field">
			    <select name="printablecolor_category_id">
				<option value="">Select Printablecolor Category</option>
				<?php foreach ($categories as $category) { ?>
				<?php if($category['status'] != '1') { ?>
				    <option value="<?php echo $category['printablecolor_category_id']; ?>"><?php echo $category['category_name'].' (Inactive)'; ?></option>
				<?php } else { ?>
				    <option value="<?php echo $category['printablecolor_category_id']; ?>"><?php echo $category['category_name']; ?></option>
				<?php } ?>
			...
			<div class="input-field">
			    <input class="fixed-width-sm" type="color" value="" name="color_code" id="color_code"> <span class="color-code" id="span_color_name">#00000</span>
			</div>
		    </div>
		<!--    <div class="field-set">
			<label>&nbsp;</label>
			<div class="input-field"> 
			    C &nbsp;<input class="inpu-centr" type="text" value="" name="c" style="width:30px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			    M &nbsp;<input class="inpu-centr" type="text" value="" name="m" style="width:30px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			    Y &nbsp;<input class="inpu-centr" type="text" value="" name="y" style="width:30px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			    K &nbsp;<input class="inpu-centr" type="text" value="" name="k" style="width:30px">
			</div>
		    </div>  -->
