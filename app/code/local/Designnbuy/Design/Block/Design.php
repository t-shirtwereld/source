...
class Designnbuy_Design_Block_Design extends Mage_Core_Block_Template {
	...
	$language_id = Mage::app()->getStore()->getLocaleCode();	
	$url = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_WEB) . 'designnbuy/pcstudio_media/mydesign?customer_id=' . $customer_id . '&plateform=' . $plateform . '&siteBaseUrl=' . $siteBaseUrl . '&language_id=' . $language_id;
	return $url;
    }
	...
	$customer_id = $customerData->getId();
	$language_id = Mage::app()->getStore()->getLocaleCode();	
	$url = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_WEB) . 'designnbuy/pcstudio_media/mymedia?customer_id=' . $customer_id . '&plateform=' . $plateform . '&siteBaseUrl=' . $siteBaseUrl . '&language_id=' . $language_id;
	return $url;
    }
