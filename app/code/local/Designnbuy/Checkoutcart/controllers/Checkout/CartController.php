...
class Designnbuy_Checkoutcart_Checkout_CartController extends Mage_Checkout_CartController {
	...
	$cart_design_id = (int) $this->getRequest()->getParam('cart_design_id');
	if($cart_design_id) {
	    Mage::helper('design')->removeCartDesignRow($cart_design_id);
	}
